      ...
      <div id="invoice-POS">
        ...
        <div id="invoice-POS">
          <center id="top" style={{ textAlign: "center" }}>
            ...
            <div className="info">
              <img
                src="/static/media/deshiattire-logo.png"
                alt={"shop Logo"}
                className="img-fluid"
                style={{
        ...
        <div style={{ textAlign: "justify" }}>
          Items may be exchanged subject to Deshiattire Bangladesh Sales & Exchange
          ...
          <hr />
          Shop Online: www.deshiattire.com
          <br />
          Queries & Complaints: +8809610963839
          <br />
          Suggestions: support@deshiattire.com
        </div>
